...
<CardGroup cols={2}>
  <Card title="Write better prompts" icon="pen-to-square" href="/arrow-0-5/text-to-svg">
    Learn MDX syntax and start writing your documentation.
  </Card>
  <Card title="Customize style" icon="palette" href="/platform/overview">
    Make your docs match your brand perfectly.
  </Card>
  <Card title="Add code examples" icon="square-code" href="/arrow-0-5/image-to-svg">
